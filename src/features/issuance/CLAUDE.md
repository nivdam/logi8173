...
- Keep success UI separate from the editable form
- Preserve the UX rules from `DECISIONS.md`

## Don't

- Do not read from global inventory for issuance stock checks
- Do not hide prerequisite problems behind disabled opaque UI
- Do not silently clear entered data when activity changes
