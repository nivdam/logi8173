...
- Do not hide destructive or permission-sensitive actions behind unclear iconography
...
- Do not assume partial import success is harmless; surface row-level failures
